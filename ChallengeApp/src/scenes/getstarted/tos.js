    ...
    >
      <ScrollView>
        <View style={styles.container}>
          <Text style={styles.masterText}> END USER LICENSE AGREEMENT</Text>
          <Text style={styles.updatetext}> Last Updated 2021-05-19 </Text>
          <Text style={styles.smallFormText}>
            Buzzle is licensed to You (End-User) by Z-Boson, located at
            Kistagången 16, Stockholm, Kista, 164 40, Sweden. (hereinafter:
            Licensor), for use only under the terms of this License Agreement.
            {"\n"}
            {"\n"}
            By downloading the Application from the Apple AppStore and Google
            Play, and any update thereto (as permitted by this License
            ...
            Google is not a Party to this License Agreement and is not bound by
            any provisions or obligations with regard to the Application, such
            as warranty, liability, maintenance and support thereof. Z-Boson,
            not Apple and Google, is solely responsible for the licensed
            ...
            Service. Z-Boson acknowledges that it had the opportunity to review
          ...
          <Text style={styles.headertext}>1. THE APPLICATION {"\n"}</Text>

          <Text style={styles.smallFormText}>
            Buzzle (hereinafter: Application) is a piece of software created as
            a Social app where you can create and participate in challenges -
            and customized for Apple and Android Devices. It is mainly used to
            create and participate in challenges.
            {"\n"}
            {"\n"}
          </Text>

          <Text style={styles.headertext}>2. SCOPE OF LICENSE{"\n"}</Text>

          <Text style={styles.smallFormText}>
            2.1 You are given a non-transferable, non-exclusive,
            non-sublicensable license to install and use the Licensed
            Application on any Apple and Google-branded Products that You
            ...
            other accounts associated with You (End-User, The Purchaser) via
            ...
            parties (unless to the degree allowed by the Apple and Google Terms
            and Conditions, and with Z-Boson's 's prior written consent), sell,
            ...
            {"\n"}
            {"\n"}
            2.6 Licensor reserves the right to modify the terms and conditions
            of licensing.
            {"\n"}
            {"\n"}
          ...
          <Text style={styles.smallFormText}>
            ...
            {"\n"}
            {"\n"}
            4.2 Z-Boson and the End-User acknowledge that Apple and Google has
        ...
        <Text style={styles.headertext}>5. USE OF DATA {"\n"}</Text>
        ...
        <Text style={styles.headertext}>7. CONTRIBUTION LICENSE {"\n"}</Text>
        ...
        <Text style={styles.headertext}>8. LIABILITY{"\n"}</Text>
        ...
        <Text style={styles.headertext}>9. WARRANTY{"\n"}</Text>
        ...
        <Text style={styles.smallFormText}>
          ...
          outside of Z-Boson's sphere of influence that affect the executability
          of the Application.
          {"\n"}
          {"\n"}
          9.3 You are required to inspect the Application immediately after
          installing it and notify Z-Boson about issues discovered without delay
          ...
          {"\n"}
          {"\n"}
          9.4 If we confirm that the Application is defective, Z-Boson reserves
          a choice to remedy the situation either by means of solving the defect
        ...
        <Text style={styles.headertext}>10. PRODUCT CLAIMS {"\n"}</Text>

        <Text style={styles.smallFormText}>
          Z-Boson and the End-User acknowledge that Z-Boson, and not Apple and
          Google, is responsible for addressing any claims of the End-User or
        ...
        <Text style={styles.headertext}>11. LEGAL COMPLIANCE{"\n"}</Text>
        ...
        <Text style={styles.headertext}>12. CONTACT INFORMATION {"\n"}</Text>

        <Text style={styles.smallFormText}>
          For general inquiries, complaints, questions or claims concerning the
          licensed Application, please contact: Z-Boson through
          https://z-boson.netlify.app/
          {"\n"}
          {"\n"}
        </Text>

        <Text style={styles.headertext}>13. TERMINATION {"\n"}</Text>

        <Text style={styles.smallFormText}>
          The license is valid until terminated by Z-Boson or by You. Your
          rights under this license will terminate automatically and without
          notice from Z-Boson if You fail to adhere to any term(s) of this
        ...
        <Text style={styles.smallFormText}>
          Z-Boson represents and warrants that Z-Boson will comply with
          ...
          Developer's End-User License Agreement," Apple and Google's
          ...
          conditions of this license agreement, Apple and Google will have the
          right (and will be deemed to have accepted the right) to enforce this
          End User License Agreement against You as a third-party beneficiary
          thereof.
          {"\n"}
          {"\n"}
        </Text>
        ...
        <Text style={styles.smallFormText}>
          Z-Boson and the End-User acknowledge that, in the event of any
          ...
          party's intellectual property rights, Z-Boson , and not Apple and
        ...
        <Text style={styles.headertext}>16. APPLICABLE LAW{"\n"}</Text>
        ...
        <Text style={styles.headertext}>17. MISCELLANEOUS {"\n"}</Text>
        ...
        <Text style={styles.smallFormText}>
          ...
          {"\n"}
          {"\n"}
          17.2 If any of the terms of this agreement should be or become
          invalid, the validity of the remaining provisions shall not be
          affected. Invalid terms will be replaced by valid ones formulated in a
          way that will achieve the primary purpose.
          {"\n"}
